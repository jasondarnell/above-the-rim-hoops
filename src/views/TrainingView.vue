      ...
      <v-col cols="6">
        ...
        >
          ...
          <v-card-text class="text-subtitle-1">
            The most personal training offered by ATR. 
          </v-card-text>
          <v-card-text class="text-body-1">
            One-on-one training - $40/hour <br />
            Two-player training - $30/athlete/hour <br />
            Three-player training - $25/athlete/hour <br />
            Four-player training - $20/athlete/hour <br />
          </v-card-text>
